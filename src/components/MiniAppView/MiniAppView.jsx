	...
	return (
		<div className={s.wrapper}>
			...
			<div className={s.phoneBlock}>
				...
				<img width={55} className={s.starGreen} src={starGreen} alt="greenStar" />
				<img width={55} className={s.starAzure} src={starAzure} alt="greenStar" />
				<img width={110} className={s.starAzure2} src={starAzure} alt="greenStar" />
				<img width={110} className={s.starBlue} src={starBlue} alt="greenStar" />
				<img width={88} className={s.starGreen2} src={starGreen} alt="greenStar" />
				<img width={60} className={s.starBlue2} src={starBlue} alt="greenStar" />
				<div className={s.shodow}>
					<div className={s.bgCloud}>
						<img style={{ zIndex: 999 }} className={s.phone} src={miniApp} alt="minApp" />
					</div>
				</div>
			</div>
			<div className={s.letters}>
				<Marquee gradient={true} gradientColor="black" speed={100} play={true} style={{ height: 96, display: "flex", alignItems: "center", gap: 50 }} direction="left">
					<img src={letters1} alt="letters1" width={"100%"} />
					<img src={letters1} alt="letters1" width={"100%"} />
				</Marquee>
				<Marquee gradient={true} gradientColor="black" speed={100} play={true} style={{ height: 96, display: "flex", alignItems: "center", gap: 50 }} direction="right">
